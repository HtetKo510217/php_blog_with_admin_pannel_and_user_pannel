    ...
    if(empty($username) || empty($email) || empty($password)) {
      ...
      if(empty($password)) {
       ...
       if($checkEmailExit) {
        ...
        //    die(var_dump($result));
           if($result) {
            echo "<script>alert('User added is successfuly !!');window.location.href='user_list.php'</script>";
           }
         }else {
  ...
  <div class="row d-flex justify-content-center my-5">
    <div class="login-box w-50 mb-5">
      <div class="login-logo mb-5">
        <a href="login.php"><b>Create User</b></a>
      </div>
      <!-- /.login-logo -->
      <div class="card">
        <div class="card-body login-card-body">
          <form action="user_add.php" method="post">
            ...
            <div class="input-group mb-4">
              ...
              <input type="checkbox" name="role" id="role" class="form-control w-25" value="1" style="margin-left: -425px;">
            </div>
            <div class="row">
              <!-- /.col -->
              <div class="col-4">
                <button type="submit" class="btn form-contr btn-primary btn-block">Create</button>
              </div>
              <!-- /.col -->
            </div>
          </form>
